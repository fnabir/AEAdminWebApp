  ...
  const onSubmit = async (data: FileDetailsFormData) => {
    ...
    const dataDetails = {
      ...
      assessmentDate: data.assessmentDate
        ? format(new Date(data.assessmentDate), 'dd/MM/yy')
        : null,
      dutyPaymentDate: data.dutyPaymentDate
        ? format(new Date(data.dutyPaymentDate), 'dd/MM/yy')
        : null,
      deliveryDate: data.deliveryDate
        ? format(new Date(data.deliveryDate), 'dd/MM/yy')
        : null,
  ...
  useEffect(() => {
    if (fileDetails) {
      setValue(
        ...
        fileDetails.beDate
          ? format(
              parse(fileDetails.beDate, 'dd/MM/yyyy', new Date()),
              'yyyy-MM-dd',
            )
          : '',
      );
      setValue(
        ...
        fileDetails.assessmentDate
          ? format(
              parse(fileDetails.assessmentDate, 'dd/MM/yy', new Date()),
              'yyyy-MM-dd',
            )
          : '',
      );
      setValue(
        ...
        fileDetails.dutyPaymentDate
          ? format(
              parse(fileDetails.dutyPaymentDate, 'dd/MM/yy', new Date()),
              'yyyy-MM-dd',
            )
          : '',
      );
      setValue(
        ...
        fileDetails.deliveryDate
          ? format(
              parse(fileDetails.deliveryDate, 'dd/MM/yy', new Date()),
              'yyyy-MM-dd',
            )
          : '',
      );
        ...
        <form className="flex-col" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex space-x-2">
            ...
            <InputText
              ...
              defaultValue={
                fileDetails?.assessableValue ? fileDetails.assessableValue : 0
              }
          ...
          <div className="flex space-x-2">
            ...
            <InputText
              ...
              defaultValue={
                fileDetails?.assessmentRef ? fileDetails.assessmentRef : 0
              }
