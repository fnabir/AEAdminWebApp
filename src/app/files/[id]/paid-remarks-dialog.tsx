...
const PaidDialog = ({ fileNo, fileYear, fileDetails }: PaidDialogProps) => {
      ...
      <DialogContent className={'border border-accent'}>
        ...
        <form className="flex-col" onSubmit={handleSubmit(onSubmit)}>
          ...
          <InputText
            ...
            pre="৳"
            helperText="Set 0 to calculate the total duty automatically"
          ...
          <DialogFooter className={'sm:justify-center pt-8 gap-4'}>
            ...
            <Button type="reset" size="lg" variant={'accent'}>
              Reset
            </Button>
          </DialogFooter>
        </form>
