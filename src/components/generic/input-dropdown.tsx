  ...
  return (
    <div className={className}>
      <div className="relative mt-4">
        ...
        <label
          htmlFor={id}
          className={`absolute text-md text-card-foreground duration-300 scale-[0.85] transform -translate-y-5 top-2 z-10 origin-[0] bg-background px-2 peer-focus:px-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-[.85] peer-focus:-translate-y-5 peer-focus:rtl:translate-x-1/4 peer-focus:rtl:left-auto start-1`}>
          {label}
